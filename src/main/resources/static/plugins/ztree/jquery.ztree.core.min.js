...
(function (q) {
    var I, J, K, L, M, N, v, s = {}, w = {}, x = {}, O = {
            ...
            return {stop: !1, node: e, nodeEventType: g, nodeEventCallback: i, treeEventType: m, treeEventCallback: n}
        }], C = [function (b) {
            var a = h.getRoot(b);
            a || (a = {}, h.setRoot(b, a));
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d, e) {
            ...
            if (a) {
                if (g.expandTriggerFlag)o = e, e = function () {
                    o &&
                    o();
            ...
            b.push("<a id='", c.tId, f.id.A, "' class='",
                f.className.LEVEL, c.level, "' treeNode", f.id.A, ' onclick="', c.click || "", '" ', e != null && e.length > 0 ? "href='" + e + "'" : "", " target='", i.makeNodeTarget(c), "' style='", m.join(""), "'");
        ...
        makeNodeUrl: function (b, a) {
            ...
            if (h.getNodeCache(b, a.tId)) {
                ...
                var o,
                    g = e[d].length;
                if (!b.data.keep.parent && g == 0)e.isParent = !1, e.open = !1, g = k(e, f.id.UL, b), j = k(e, f.id.SWITCH, b), o = k(e, f.id.ICON, b), i.replaceSwitchClass(e, j, f.folder.DOCU), i.replaceIcoClass(e, o, f.folder.DOCU), g.css("display", "none"); else if (b.view.showLine && g > 0) {
                    var n = e[d][g - 1], g = k(n, f.id.UL, b), j = k(n, f.id.SWITCH, b);
                    o = k(n, f.id.ICON, b);
                    e == c ? e[d].length == 1 ? i.replaceSwitchClass(n, j, f.line.ROOT) : (c = k(e[d][0], f.id.SWITCH, b), i.replaceSwitchClass(e[d][0], c, f.line.ROOTS), i.replaceSwitchClass(n, j, f.line.BOTTOM)) : i.replaceSwitchClass(n,
                        j, f.line.BOTTOM);
            ...
            if (a) {
                ...
                g.length ==
                0 ? d.removeClass(f.line.LINE) : d.addClass(g);
    ...
    q.fn.zTree = {
        consts: {
            ...
            b[a] = d.data.simpleData.enable ? h.transformTozTreeFormat(d,
                c) : c;
            h.initCache(d);
            l.unbindTree(d);
            l.bindTree(d);
            ...
            c = {
                setting: d, addNodes: function (a, b, c, f) {
                    ...
                    !j.canAsync(d, a) && c ? i.expandCollapseSonNode(d,
                        a, b, !0, l) : (a.open = !b, i.switchNode(this.setting, a), l());
                    return b
                }, getNodes: function () {
                    return h.getNodes(d)
                ...
                reAsyncChildNodes: function (a, b, c) {
                    if (this.setting.async.enable) {
                        ...
                        j && (a = h.getRoot(d));
                        if (b == "refresh") {
                            for (var b = this.setting.data.key.children, l = 0, q = a[b] ? a[b].length : 0; l < q; l++)h.removeNodeCache(d, a[b][l]);
                    ...
                    h.initCache(d);
                    i.createNodes(d,
                        0, a[d.data.key.children], null, -1)
                    ...
                    if (a && j.uCanDo(d)) {
                        ...
                        if (a.parentTId)i.expandCollapseParentNode(d,
                            a.getParentNode(), !0, !1, f); else try {
                            k(a, d).focus().blur()
                        } catch (h) {
                        }
                        i.selectNode(d, a, b)
            ...
            b.treeTools = c;
            h.setZTreeTools(d, c);
            b[a] && b[a].length > 0 ? i.createNodes(d, 0, b[a], null, -1) : d.async.enable && d.async.url &&
            d.async.url !== "" && i.asyncNode(d);
            return c
        }
    };
